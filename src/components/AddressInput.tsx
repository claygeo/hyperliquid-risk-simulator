        ...
        <div className="flex-1 relative">
          <input
            ...
            className="w-full bg-black/70 backdrop-blur-sm border border-gray-800/60 rounded-md px-4 py-3
                     ...
                     focus:bg-black/90 transition-all duration-150 pr-32"
            style={{ fontSize: '16px', fontFamily: 'SF Mono, Monaco, Consolas, monospace' }} // Monospace + no iOS zoom
            disabled={isLoading}
          />
          ...
          <div className="absolute right-2 top-1/2 -translate-y-1/2 flex gap-1">
            {address && (
              <>
                {/* Copy button - subtle icon that becomes checkmark */}
                <button
                  type="button"
                  onClick={handleCopy}
